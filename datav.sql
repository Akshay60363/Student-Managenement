...
CREATE TABLE ExamResults (
    ...
    CONSTRAINT fk_examresults_course FOREIGN KEY (CourseID) REFERENCES Courses(CourseID)
...
INSERT INTO Admins (AdminID, FirstName, UserName, Password)
VALUES
(1, 'Akask', 'admin1', 'admin1'),
(2, 'Adi', 'admin2', 'admin2');
...
INSERT INTO ExamResults (ResultID, StudentID,  Marks, Grade,CourseID)
VALUES
(501, 1, 85, 'A',201),
(502, 2, 78, 'B',202);
